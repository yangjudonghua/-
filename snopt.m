...
% Copyright (c) 2000-2006 by Tomlab Optimization Inc., Sweden. $Release: 8.6.0$
% Written July 4, 2000.   Last modified Apr 18, 2019.
%# mex

function varargout = snopt(varargin)
missingTomlabMex(mfilename('fullpath'),'snopt')
% This file is not expected to be run - if it is called, the corresponding
% MEX file is missing from the Tomlab installation.
end
