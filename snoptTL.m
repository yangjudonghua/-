...
% Copyright (c) 2000-2018 by Tomlab Optimization Inc., $Release: 8.5.0$
% Written July 4, 2000.   Last modified Aug 15, 2018.
...
if nargin < 1, error('snoptTL needs the Prob structure as input');end
...
Result.Solver='snopt';
Result.SolverAlgorithm='SNOPT 7.7 NLP code';
...
Result.c_k=fCon;
Result.x_k=xs(1:n);
% SNOPT is sloopy, returns xs violating simple bounds up to Prob.SOL.optPar(10)
% Result.x_k=min(bu(1:n),max(bl(1:n),xs(1:n)));
Result.x_0=x_0;
